 ...
 * 
 * 2. controlled element: use individual field state for each input field. where, needed to add initial value set.
 * 
 ...
 * 
 * 5.custom hook: use hook to handle states and submit and error. example react hook form
 * 
